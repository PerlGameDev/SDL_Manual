...
In this chapter we will look at our Pong Code from Chapter 6. The script is provided 
for you in the C<code_listings/pong.pl> on U<http://github.com/PerlGameDev/SDL_Manual/> 
...
Run this code which is provided in C<code_listings/pong_profile_1.pl>, and it will close sortly
