...
for each chapter will be broken up and explained. Sources and data files will be provided on http://sdl.perl.org.
...
Alien::SDL will compile SDL deps from scratch with no problems as long some prerequisites are installed. libfreetype6, libX11, libvorbis, and libpng headers will suffice for most examples in this book.
