...
What we can do is keep track of the number of frames we are having and divide it by the time elasped from the last frame. 
	...
	$app->draw_gfx_text( [10,10], "FPS: $FPS", [255,0,255,255]);
