...
While in the C<SDLx::*> layer is as simple as:
...
A secondary purpose of the C<SDLx::*> is to add addtional features for user, such as Layers, Game Loop handling and more.
