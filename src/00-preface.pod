...
In addition to the core library there are several other libraries that provide many
...
The main purpose of the C<SDLx::*> layer is to smooth out the drudgery from the C<SDL::*> layer.
...
A secondary purpose of the C<SDLx::*> is to add addtional features for users, such as Layers, Game Loop handling and more.
