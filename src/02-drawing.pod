...
can be used to make our flower. Besides a making drawing simpler, C<SDLx::Sprite> adds several other features 
...
on the ground. Delete everything including and after C< $flower->draw_xy($app, 0,0)>, and insert the below code to 
get a field of flowers.
