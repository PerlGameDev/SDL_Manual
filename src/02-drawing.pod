...
X<SDLx::App> is a C<SDLx::Surface>. This means that we can draw directly on the C<SDLx::App>, however there are 
...
The values of the numbers range from 0-255 for 32 depth in RGBA format.
...
Other options are 24,16 and 8. 32 is the default depth.
