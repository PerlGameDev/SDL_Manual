...
Using our knowledge of Primitives in SDL, lets draw our simple flower.
...
Surface are generally expensive in terms on memory. Therefore, it is usually a good idea
to keep only one copy of it, sort of like a palette. Because we want lots of the same
flower or C<SDLx::Surface> to be drawn lets make our flower a C<SDLx::Sprite>.
